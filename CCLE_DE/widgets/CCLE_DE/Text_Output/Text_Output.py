...
class OWText_Output(OWBwBWidget):
    name = "Text_Output"
    description = "Enter and output a file"
    priority = 10
    icon = getIconName(__file__,"file.png")
    want_main_area = False
    docker_image_name = "text-output"
    docker_image_tag = "test"
    inputs = [("file",str,"handleInputsfile"),("trigger",str,"handleInputstrigger")]
    outputs = [("file",str)]
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"Text_Output")) as f:
